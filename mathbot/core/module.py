...
class Module:
	...
	def collect_background_tasks(self) -> typing.List[core.handles.BackgroundTask]:
		''' Returns a list of the module's background tasks. '''
		return self.collect_by_type(core.handles.BackgroundTask)

	def collect_startup_tasks(self) -> typing.List[core.handles.StartupTask]:
